        ...
        <Row className="justify-content-center">
          <Col xs={12} md={8}>
            <p className="text-start">
              ...
              Spire is proud of a heritage that began in Hawai‘i
              over six decades ago—a heritage that inspires the firm’s
              mission to help build a brighter future for the companies
              and communities it serves.
            </p>
            <Card className="shadow-sm mt-4">
              <Card.Body>
                <Card.Title as="h3">Nimbleness is a Strategic Imperative in Today’s World</Card.Title>
                ...
                <Card.Subtitle as="h4" className="mb-2">Integrated Solutions with Context and Orientation</Card.Subtitle>
                <Card.Text>
                  We embrace complexity, tackling interdependent challenges with thoughtful, integrated solutions. Rather than passing problems forward, we focus on meaningful, long-term resolutions.
                </Card.Text>
                <Card.Text>
                  Responsible business practice means addressing economic, social, and environmental needs. We offer multi-dimensional solutions for a multi-dimensional world.
                </Card.Text>
              </Card.Body>
            </Card>
          </Col>
